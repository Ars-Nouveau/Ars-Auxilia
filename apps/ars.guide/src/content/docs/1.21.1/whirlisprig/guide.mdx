...
## **Happiness**
Happiness is determined by the total number of blocks that the Whirlisprig accepts.
- There are 2 main groups of blocks the Whirlisprigs will accept: liked blocks and loved blocks. Right clicking on a sprig with a block will tell you which one it is: "The Whirlisprig would be excited to have this in their home!" for loved, and "The Whirlisprig likes this block!" for liked.
...
- Whirlisprigs have 5 Happiness levels
...
## Diversity
Diversity is determined by the amount of unique accepted blocks you have.
- Diversity starts at 1 by default, although unless you prepare an area for it stuff like grass blocks and flowers will already make it increase a little. 
...
| Diversity                                                                                         | Score |
|---------------------------------------------------------------------------------------------------|-------|
| There does not appear to be much diversity                                                        | 1-11  |
| There is some diversity but it could be better                                                    | 12-21 |
| The Whirlisprig thinks her home is very diverse                                                   | 22-39 |
| The home is extremely diverse, but Whirlisprig will never turn down a new addition to their home! | 40+   |


## Progress
Every time you see the little flying block with a green trail go towards the blossom, the progress value increases by tick.
- The increase happens at the start of the animation, the animation is just for aesthetics
- For example at 101 moodScore, every time the animation plays the progress value increases by 3
- The loot is generated once the progress value has reached 256. After that it goes back to 0
- The number that the progress value is increased by each time a whirlisprig "casts" is the moodScore / 30 rounded down. The amount of progress increased each time is directly connected to the whirlisprig happiness and diversity scores
...
## Filtering
 ...
 - You can set new items in the filter by reusing a Deny Scroll on a Whirlisprig
...
**Notes**
- Whirlisprigs go by She/They (this is more for fun I know) as seen from "The Whirlisprig thinks her home is very diverse" and "The Whirlisprig would be excited to have this in their home!"
